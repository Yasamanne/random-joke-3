...
Submitted by: **Random Jokes**

Time spent: **half an hour** hours spent in total

## Summary

**Random Jokes 3** is an android app that **Is the beautiful version of random joke 2**
...
<img src='http://g.recordit.co/jDRGkF7qrg.gif' title='Video Demo' width='' alt='Video Demo' />
